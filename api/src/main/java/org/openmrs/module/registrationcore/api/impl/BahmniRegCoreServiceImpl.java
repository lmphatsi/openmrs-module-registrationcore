...
import org.openmrs.module.registrationcore.api.BahmniRegCoreService;
 ...
 */
@Transactional
public class BahmniRegCoreServiceImpl extends BaseOpenmrsService implements BahmniRegCoreService, GlobalPropertyListener, ApplicationContextAware {
	...
	/**
     * @see RegistrationCoreService#registerPatient(Patient,
    ...
    /**
     * @see RegistrationCoreService#registerPatient(Patient, List, String, Location)
     */
    @Override
	...
	/**
	 * @see RegistrationCoreService#registerPatient(RegistrationData)
	 */
	@Override
	...
	/**
	 * @see RegistrationCoreService#findSimilarGivenNames(String)
	 */
	@Override
    @Transactional(readOnly = true)
	...
	/**
	 * @see RegistrationCoreService#findSimilarFamilyNames(String)
	 */
	@Override
    @Transactional(readOnly = true)
